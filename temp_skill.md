---
name: slash-help
description: "Get help with the hookify plugin Use when the user invokes `/help` or asks for the converted Claude command workflow."
---

# help

Converted by Obsigravity from a local Claude Code slash command.

- Source: `/Users/anjaemo/.claude/plugins/marketplaces/claude-plugins-official/plugins/hookify/commands/help.md`
- Original kind: `command`

## Usage

Use when the user invokes `/help` or asks for the converted Claude command workflow.
