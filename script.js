...
function renderSummary(data, tableElement) {
    ...
    data.forEach((row, i) => {
        ...
        if (name === "" && i === 0) return; // Header
        if (name === "" && i > 0 && row[1]) name = "계좌 " + i;
